 ...
 *
 * Nesta implementação simples tem por objetivos:
 * 		.Criar um arquivo de video utilizando a biblioteca
 *		.Criar arquivos de videos utilizando frames que sofrem alteração, ou seja, frames com imagens distintas
*/
...
/*Descomentar linha abaixo, para utilizar a camera externa, ou o padrão plugado na maquina*/
...
{	
	...
	/*Realiza a diferença em modulo e retorna o resultado em outra matriz*/
	absdiff(g1, g2, res);
